...
public class FrameworkLauncher {
	...
	/** Launch the distributed environment and its associated UI.
	 * 
	 * @param environmentAgentType the type of the environment agent to launch.
	 * @param environment is the environment to use.
	 * @param gui is the GUI to launch.
	 * @throws Exception if the Janus platform cannot be started.
	 */
	 ...
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static void launchSimulatedAgent(Class<? extends AbstractAnimat> agentType,
			DynamicType behaviorType, Object... parameters) throws Exception {
		Boot.setOffline(true);
		Boot.setVerboseLevel(LoggerCreator.toInt(Level.INFO));
		Boot.showJanusLogo();
		
		Object[] params = new Object[1];
		params[0] = behaviorType;
