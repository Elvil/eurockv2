...
public class Rabbit extends AbstractAnimat {
  ...
  public void _handle_PerceptionEvent_1(final PerceptionEvent occurrence) {
    ...
    if ((target == null)) {
      ...
      if (_equals) {
        ...
        BehaviourOutput _runSeek = this.seekBehaviour.runSeek(_position_1, _currentLinearSpeed_1, _maxLinear_1, _position_2);
        TypeChangeInfluence _typeChangeInfluence_1 = new TypeChangeInfluence("RAVENOUS");
        ...
        Point2f _position_4 = target.getPosition();
        BehaviourOutput _runFlee = this.fleeBehaviour.runFlee(_position_3, _currentLinearSpeed_2, _maxLinear_2, _position_4);
   ...
   */
  @Generated
  public Rabbit(final UUID parentID) {
    super(parentID, null);
  }
   ...
   */
  @Generated
  public Rabbit(final UUID parentID, final UUID agentID) {
