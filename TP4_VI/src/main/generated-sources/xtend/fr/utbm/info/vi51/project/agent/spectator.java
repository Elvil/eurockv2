...
public class spectator extends AbstractAnimat {
  ...
  protected final float WANDER_CIRCLE_DISTANCE = 200f;
  
  protected final float WANDER_CIRCLE_RADIUS = 100f;
  ...
  public void _handle_PerceptionEvent_1(final PerceptionEvent occurrence) {
    ...
    if ((target != null)) {
      ...
      boolean _equals = _name.equals("SceneUn");
      if (_equals) {
        _or_3 = true;
      } else {
        String _name_1 = target.getName();
        boolean _equals_1 = _name_1.equals("SceneDeux");
        _or_3 = _equals_1;
      }
      if (_or_3) {
        _or_2 = true;
        ...
        boolean _equals_2 = _name_2.equals("SceneTrois");
        _or_2 = _equals_2;
      }
      if (_or_2) {
        _or_1 = true;
        ...
        boolean _equals_3 = _name_3.equals("SCENE");
        _or_1 = _equals_3;
      }
      if (_or_1) {
        _or = true;
        ...
        boolean _equals_4 = _name_4.equals("Mouse Target");
        _or = _equals_4;
      }
      if (_or) {
        ...
        BehaviourOutput _runFlee = this.fleeBehaviour.runFlee(_position, _currentLinearSpeed, _maxLinearSpeed, _position_1);
        TypeChangeInfluence _typeChangeInfluence = new TypeChangeInfluence(State.CALM);
        this.emitInfluence(_runFlee, _typeChangeInfluence);
      } else {
        ...
        float _maxLinearSpeed_1 = occurrence.body.getMaxLinearSpeed();
        ...
        BehaviourOutput _runWander = this.wanderBehaviour.runWander(_position_2, _direction, _currentLinearSpeed_1, _maxLinearSpeed_1, _currentAngularSpeed, _maxAngularSpeed);
        UUID _bodyID = occurrence.body.getBodyID();
        TestInfluence _testInfluence = new TestInfluence(_bodyID, "Test");
        this.emitInfluence(_runWander, _testInfluence);
      }
    } else {
      ...
      float _maxLinearSpeed_2 = occurrence.body.getMaxLinearSpeed();
      float _currentAngularSpeed_1 = occurrence.body.getCurrentAngularSpeed();
      float _maxAngularSpeed_1 = occurrence.body.getMaxAngularSpeed();
      BehaviourOutput _runWander_1 = this.wanderBehaviour.runWander(_position_3, _direction_1, _currentLinearSpeed_2, _maxLinearSpeed_2, _currentAngularSpeed_1, _maxAngularSpeed_1);
      TypeChangeInfluence _typeChangeInfluence_1 = new TypeChangeInfluence(State.CALM);
      this.emitInfluence(_runWander_1, _typeChangeInfluence_1);
    }
  }
